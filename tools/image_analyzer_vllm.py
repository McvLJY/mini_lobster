...
@tool(
    name="execute_image_analysis",
    param_descriptions={
        "image_path": "图片文件的完整路径",
        "question": "关于图片的问题，如'这张图片里有什么？'、'请详细描述'等",
        "purpose": "分析目的说明"
    },
    category="vision",
    version="1.0.0"
...
if __name__ == "__main__":
    ...
    # 查看 analyze_image 的 schema
    print("\n🔧 analyze_image schema：")
    schema = tool_registry._tool_schemas.get("analyze_image")
    if schema:
        print(json.dumps(schema, ensure_ascii=False, indent=2))
    else:
        print("❌ 没找到 analyze_image")